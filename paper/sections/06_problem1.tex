...
以 \(\delta\) 为自变量，将式\eqref{eq:q1-buoyancy}--
\eqref{eq:q1-buoy-vertical}确定的浮标受力作为起点；再依次使用
式\eqref{eq:q1-pipe-force-balance}--\eqref{eq:q1-pipe-angle}、
式\eqref{eq:q1-bucket-horizontal}--\eqref{eq:q1-bucket-moment-lower}和锚链段的
逐节平衡关系，计算各节的张力与姿态。最后由式\eqref{eq:q1-water-depth}和
式\eqref{eq:q1-swing-radius}得到海水深度与游动半径随 \(\delta\) 的变化关系，
并分别在两种给定风速下求解相应的系统状态。
